...
var file_system_user_dept_proto_goTypes = []interface{}{
...
func file_system_user_dept_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_system_user_dept_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_system_user_dept_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_system_user_dept_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_system_user_dept_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_system_user_dept_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_system_user_dept_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_system_user_dept_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_system_user_dept_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_system_user_dept_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
