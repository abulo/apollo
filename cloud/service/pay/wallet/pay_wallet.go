...
// PayWalletCustomDao 数据转换
func PayWalletCustomDao(item *PayWalletCustomObject) *dao.PayWalletCustom {
	daoItem := &dao.PayWalletCustom{}
...
// PayWalletCustomProto 数据绑定
func PayWalletCustomProto(item dao.PayWalletCustom) *PayWalletCustomObject {
	res := &PayWalletCustomObject{}
	if item.Id != nil {
		res.Id = item.Id
	}
	if item.UserId != nil {
