...
export const getSystemPostListApi = (params?: SystemPost.ReqSystemPostList) => {
  return http.get<SystemPost.ResSystemPostItem[]>(PORT + `/system/post`, params);
};
// 获取单个职位
...
// 获取职位树
export const getSystemPostSearchApi = (params?: SystemPost.ReqSystemPostList) => {
  return http.get<SystemPost.ResSystemPostItem[]>(PORT + `/system/post/search`, params);
};
