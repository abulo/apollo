      ...
      <Grid ref="gridRef" :collapsed="collapsed" :gap="[20, 0]" :cols="searchCol">
        <GridItem v-for="(item, index) in columns" :key="item.field" v-bind="getResponsive(item)" :index="index">
          <el-form-item>
            ...
            <VirtualSearchFormItem :column="item" :search-param="searchParam" />
          </el-form-item>
        </GridItem>
        <GridItem suffix>
          <div class="operation">
...
<script setup lang="ts" name="VirtualSearchForm">
import { computed, ref } from "vue";
import { ColumnProps } from "@/components/VirtualTable/interface";
import { BreakPoint } from "@/components/Grid/interface";
import { Delete, Search, ArrowDown, ArrowUp } from "@element-plus/icons-vue";
import VirtualSearchFormItem from "./components/VirtualSearchFormItem.vue";
